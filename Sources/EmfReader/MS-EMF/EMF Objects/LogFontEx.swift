...
public struct LogFontEx {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        self.fullName = try dataStream.readString(count: 128, encoding: .ascii)!.trimmingCharacters(in: ["\0"])
        ...
        self.style = try dataStream.readString(count: 64, encoding: .ascii)!.trimmingCharacters(in: ["\0"])
        ...
        self.script = try dataStream.readString(count: 64, encoding: .ascii)!.trimmingCharacters(in: ["\0"])
    }
}
