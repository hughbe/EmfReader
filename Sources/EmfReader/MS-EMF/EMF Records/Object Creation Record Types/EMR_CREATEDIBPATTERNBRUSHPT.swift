//
//  EMR_CREATEDIBPATTERNBRUSHPT.swift
//
//
...
/// The pattern brush object defined by this record can be selected into the playback device context by an EMR_SELECTOBJECT record
/// (section 2.3.8.5), which specifies the pattern brush to use in subsequent graphics operations.
/// See section 2.3.7 for more object creation record types.
public struct EMR_CREATEDIBPATTERNBRUSHPT {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        guard self.type == RecordType.EMR_CREATEDIBPATTERNBRUSHPT else {
        ...
        /// ihBrush (4 bytes): An unsigned integer that specifies the index of the pattern brush object in the EMF object table (section
